  ...
  return (<div className="p-background" >
    <div className="p-container">
      <div className="p-title">
        <div className="p-title-item">Pomodoro</div>
        <div className="p-title-item">Short Break</div>
        <div className="p-title-item">Long Break</div>
      </div>
      <div className="p-timer">25:00</div>
      <div>
